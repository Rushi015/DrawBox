...
export default function App() {
  ...
  useEffect(() => {
    // Pushing the initial state to history
    if (historyPointer === -1) {
      setHistory([
        {
          rectangles: [],
  ...
  function updateHistory(newRectangles, newCircles, newArrows, newScribbles) {
    const newState = {
    ...
    switch (action) {
      case ACTIONS.RECTANGLE:
        setRectangles((rectangles) => {
          ...
          updateHistory(newRectangles, circles, arrows, scribbles);
      ...
      case ACTIONS.CIRCLE:
        setCircles((circles) => {
          ...
          updateHistory(rectangles, newCircles, arrows, scribbles);
          return newCircles;
        });
        break;
      case ACTIONS.ARROW:
        setArrows((arrows) => {
          ...
          updateHistory(rectangles, circles, newArrows, scribbles);
          return newArrows;
        });
        break;
      case ACTIONS.SCRIBBLE:
        setScribbles((scribbles) => {
          ...
          updateHistory(rectangles, circles, arrows, newScribbles);
          return newScribbles;
        });
        break;
    }
